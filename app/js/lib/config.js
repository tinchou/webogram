...
Config.Emoji = {
  ...
  "1f1e8-1f1fd":{code:"🇨🇽",shortcuts:["christmas island"],x:17,y:35}, <------ here!
  ...
  "1f1f2-1f1f5":{code:"🇲🇵",shortcuts:["northern mariana islands"],x:1,y:38},
  ...
  "1f1f3-1f1e8":{code:"🇳🇨",shortcuts:["new caledonia"],x:33,y:37},
  "1f1f3-1f1ea":{code:"🇳🇪",shortcuts:["niger"],x:36,y:37},
  "1f1f3-1f1eb":{code:"🇳🇫",shortcuts:["norfolk island"],x:39,y:37},
  "1f1f3-1f1ec":{code:"🇳🇬",shortcuts:["nigeria"],x:37,y:37},
  "1f1f3-1f1ee":{code:"🇳🇮",shortcuts:["nicaragua"],x:35,y:37},
  "1f1f3-1f1f1":{code:"🇳🇱",shortcuts:["netherlands"],x:32,y:37},
  "1f1f3-1f1f4":{code:"🇳🇴",shortcuts:["norway"],x:2,y:38},
  "1f1f3-1f1f5":{code:"🇳🇵",shortcuts:["nepal"],x:31,y:37},
  "1f1f3-1f1f7":{code:"🇳🇷",shortcuts:["nauru"],x:30,y:37},
  "1f1f3-1f1fa":{code:"🇳🇺",shortcuts:["niue"],x:38,y:37},
  "1f1f3-1f1ff":{code:"🇳🇿",shortcuts:["new zealand"],x:34,y:37},
  "1f1f4-1f1f2":{code:"🇴🇲",shortcuts:["oman"],x:3,y:38},
  "1f1f5-1f1e6":{code:"🇵🇦",shortcuts:["panama"],x:7,y:38},
  "1f1f5-1f1ea":{code:"🇵🇪",shortcuts:["peru"],x:10,y:38},
  "1f1f5-1f1eb":{code:"🇵🇫",shortcuts:["french polynesia"],x:36,y:35},
  "1f1f5-1f1ec":{code:"🇵🇬",shortcuts:["papua new guinea"],x:8,y:38},
  "1f1f5-1f1ed":{code:"🇵🇭",shortcuts:["philippines"],x:11,y:38},
  "1f1f5-1f1f0":{code:"🇵🇰",shortcuts:["pakistan"],x:4,y:38},
  "1f1f5-1f1f1":{code:"🇵🇱",shortcuts:["poland"],x:13,y:38},
  "1f1f5-1f1f2":{code:"🇵🇲",shortcuts:["saint pierre and miquelon"],x:5,y:39},
  "1f1f5-1f1f3":{code:"🇵🇳",shortcuts:["pitcairn"],x:12,y:38},
  "1f1f5-1f1f7":{code:"🇵🇷",shortcuts:["puerto rico"],x:15,y:38},
  "1f1f5-1f1f8":{code:"🇵🇸",shortcuts:["palestinian territory"],x:6,y:38},
  "1f1f5-1f1f9":{code:"🇵🇹",shortcuts:["portugal"],x:14,y:38},
  "1f1f5-1f1fc":{code:"🇵🇼",shortcuts:["palau"],x:5,y:38},
  "1f1f5-1f1fe":{code:"🇵🇾",shortcuts:["paraguay"],x:9,y:38},
  "1f1f6-1f1e6":{code:"🇶🇦",shortcuts:["qatar"],x:16,y:38},
  "1f1f7-1f1ea":{code:"🇷🇪",shortcuts:["réunion"],x:17,y:38},
  "1f1f7-1f1f4":{code:"🇷🇴",shortcuts:["romania"],x:18,y:38},
  "1f1f7-1f1f8":{code:"🇷🇸",shortcuts:["serbia"],x:26,y:38},
  "1f1f7-1f1fa":{code:"🇷🇺",shortcuts:["russia"],x:19,y:38},
  "1f1f7-1f1fc":{code:"🇷🇼",shortcuts:["rwanda"],x:20,y:38},
  "1f1f8-1f1e6":{code:"🇸🇦",shortcuts:["saudi arabia"],x:24,y:38},
  "1f1f8-1f1e7":{code:"🇸🇧",shortcuts:["solomon islands"],x:34,y:38},
  "1f1f8-1f1e8":{code:"🇸🇨",shortcuts:["seychelles"],x:27,y:38},
  "1f1f8-1f1e9":{code:"🇸🇩",shortcuts:["sudan"],x:7,y:39},
  "1f1f8-1f1ea":{code:"🇸🇪",shortcuts:["sweden"],x:10,y:39},
  "1f1f8-1f1ec":{code:"🇸🇬",shortcuts:["singapore"],x:29,y:38},
  "1f1f8-1f1ed":{code:"🇸🇭",shortcuts:["saint helena, ascension and tristan da cunha"],x:2,y:39},
  "1f1f8-1f1ee":{code:"🇸🇮",shortcuts:["slovenia"],x:32,y:38},
  "1f1f8-1f1ef":{code:"🇸🇯",shortcuts:["svalbard and jan mayen"],x:31,y:38},
  "1f1f8-1f1f0":{code:"🇸🇰",shortcuts:["slovakia"],x:28,y:38},
  "1f1f8-1f1f1":{code:"🇸🇱",shortcuts:["sierra leone"],x:22,y:38},
  "1f1f8-1f1f2":{code:"🇸🇲",shortcuts:["san marino"],x:25,y:38},
  "1f1f8-1f1f3":{code:"🇸🇳",shortcuts:["senegal"],x:35,y:38},
  "1f1f8-1f1f4":{code:"🇸🇴",shortcuts:["somalia"],x:8,y:39},
  "1f1f8-1f1f7":{code:"🇸🇷",shortcuts:["suriname"],x:38,y:38},
  "1f1f8-1f1f8":{code:"🇸🇸",shortcuts:["south sudan"],x:23,y:38},
  "1f1f8-1f1f9":{code:"🇸🇹",shortcuts:["sao tome and principe"],x:24,y:35},
  "1f1f8-1f1fb":{code:"🇸🇻",shortcuts:["el salvador"],x:30,y:38},
  "1f1f8-1f1fd":{code:"🇸🇽",shortcuts:["sint maarten (dutch part)"],x:12,y:39},
  "1f1f8-1f1fe":{code:"🇸🇾",shortcuts:["syrian arab republic"],x:9,y:39},
  "1f1f8-1f1ff":{code:"🇸🇿",shortcuts:["swaziland"],x:25,y:39},
  "1f1f9-1f1e8":{code:"🇹🇨",shortcuts:["turks and caicos islands"],x:1,y:35},
  "1f1f9-1f1e9":{code:"🇹🇩",shortcuts:["chad"],x:1,y:35},
  "1f1f9-1f1eb":{code:"🇹🇫",shortcuts:["french southern territories"],x:37,y:35},
  "1f1f9-1f1ec":{code:"🇹🇬",shortcuts:["togo"],x:18,y:39},
  "1f1f9-1f1ed":{code:"🇹🇭",shortcuts:["thailand"],x:16,y:39},
  "1f1f9-1f1ef":{code:"🇹🇯",shortcuts:["tajikistan"],x:14,y:39},
  "1f1f9-1f1f0":{code:"🇹🇰",shortcuts:["tokelau"],x:19,y:39},
  "1f1f9-1f1f1":{code:"🇹🇱",shortcuts:["timor-leste"],x:17,y:39},
  "1f1f9-1f1f2":{code:"🇹🇲",shortcuts:["turkmenistan"],x:24,y:39},
  "1f1f9-1f1f3":{code:"🇹🇳",shortcuts:["tunisia"],x:22,y:39},
  "1f1f9-1f1f4":{code:"🇹🇴",shortcuts:["tonga"],x:20,y:39},
  "1f1f9-1f1f7":{code:"🇹🇷",shortcuts:["turkey"],x:23,y:39},
  "1f1f9-1f1f9":{code:"🇹🇹",shortcuts:["trinidad and tobago"],x:21,y:39},
  "1f1f9-1f1fb":{code:"🇹🇻",shortcuts:["tuvalu"],x:26,y:39},
  "1f1f9-1f1fc":{code:"🇹🇼",shortcuts:["taiwan"],x:13,y:39},
  "1f1f9-1f1ff":{code:"🇹🇿",shortcuts:["tanzania"],x:15,y:39},
  "1f1fa-1f1e6":{code:"🇺🇦",shortcuts:["ukraine"],x:29,y:39},
